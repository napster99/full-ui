...
<script>
import Popper from 'full-ui/src/utils/vue-popper';
import Clickoutside from 'full-ui/src/utils/clickoutside';
import Emitter from 'full-ui/src/mixins/emitter';
import Locale from 'full-ui/src/mixins/locale';
import Migrating from 'full-ui/src/mixins/migrating';
import ElInput from 'full-ui/packages/input';
import ElTag from 'full-ui/packages/tag';
import ElScrollbar from 'full-ui/packages/scrollbar';
import ElCascaderPanel from 'full-ui/packages/cascader-panel';
import AriaUtils from 'full-ui/src/utils/aria-utils';
import { t } from 'full-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'full-ui/src/utils/util';
import { isUndefined, isFunction } from 'full-ui/src/utils/types';
import { isDef } from 'full-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'full-ui/src/utils/resize-event';
